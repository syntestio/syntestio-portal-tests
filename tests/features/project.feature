...
Scenario: Create new project
  ...
  And I remove existing project if any is assigned
  ...
  When I attempt to create another project with any random new name and description
