...
Scenario: View tiers after registration
  ...
  And I click on sign up and create account with email &newTierAccountEmail and password &password (using the visible Submit button, not the aria-hidden one) until I see select tier page
