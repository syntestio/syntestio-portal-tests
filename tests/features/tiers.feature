...
Scenario: View tiers after registration
  ...
  And I create account with email &newTierAccountEmail and password &password until I see select tier page (using the visible Submit button, not the aria-hidden one)
